...
/****** Object:  StoredProcedure [new].[SP_DIM_ANSWER]    Script Date: 2020-04-09 12:48:52 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER                 PROCEDURE [new].[SP_DIM_ANSWER]
AS
BEGIN
...
SELECT @TABLE_COUNT = COUNT(1) FROM new.DimAnswer

IF(@TABLE_COUNT > 0)
BEGIN
DELETE new.DimAnswer
END

INSERT INTO new.DimAnswer
...
WHERE TABLE_NAME LIKE 'generic.new_%') S_BASE 
) BASE
JOIN new.DimQuestion DQ ON DQ.QUESTION = BASE.QUESTION
