...
/****** Object:  StoredProcedure [new].[SP_DIM_QUESTION]    Script Date: 2020-04-09 12:49:45 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER               PROCEDURE [new].[SP_DIM_QUESTION]
AS
BEGIN
...
SELECT @TABLE_COUNT = COUNT(1) FROM new.DimQuestion

IF(@TABLE_COUNT > 0)
BEGIN
DELETE new.DimQuestion
END

INSERT INTO new.DimQuestion
SELECT 
...
WHERE TABLE_NAME LIKE 'generic.new_%') BASE
